...
function HospitalManagement() {
    ...
    function retrivePatients() {
        setLoading(true);
        axios.get(`${config.url}/api/patients/get`)
    ...
    function createPatient() {
        axios.post(`${config.url}/api/patients/post`, formData)
            .then(() => {
                retrivePatients();
                resetForm();
            })
    ...
    function updatePatient() {
        axios.put(`${config.url}/api/patients/${formData.id}`, formData)
            .then(() => {
                retrivePatients();
                resetForm();
    ...
    function deletePatient(id) {
        axios.delete(`${config.url}/api/patients/${id}`)
